...
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "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")
...
def analyze_video_ai(request: VideoAnalysisRequest):
    """
