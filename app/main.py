...
def analyze_video(request: dict):
    try:
        ...
        # Mock AI response for now - replace with real OpenRouter call
        return {
            "success": True,
            "video_url": video_url,
            "clips": [
                {
                    ...
                    "hook": "Mind-blowing moment that hooks viewers",
                    "reason": "Strong emotional trigger with immediate payoff"
                },
                {
                    "id": 2,
                    "start_time": "00:03:00",
                    ...
                    "hook": "Surprising revelation",
                    "reason": "Valuable insight with broad appeal"
                }
            ],
